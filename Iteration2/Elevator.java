...
public class Elevator implements Runnable {
    ...
    public void initializeElevator() {
        this.currentFloor = 0; // Initial state of the elevator as it starts at the first floor
    ...
    public BlockingQueue<Inform> getCurrentElevatorQueue(){
        return sharedBuffer.getElevatorQueue();
    }

    public BlockingQueue<Inform> getCurrentFloorQueue() {
        return sharedBuffer.getFloorRequests();
    }
